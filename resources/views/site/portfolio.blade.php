      ...
      <div class="col-lg-12 mx-auto">
        ...
        <ul class="timeline">
          ...
          <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="spacelingo-min">
                  <div class="spacelingo-min-logo">
                    <h3 class="texto-dark"><b><img src="{{asset('img/spacelingo.png')}}" width="40px"> SpaceLingo</b></h3>
                  </div>
                </div>
                <p></p>
                <small>
                  <b class="texto-dark">Objetivo: </b>
                  Ter apoio da tecnologia no estudo de outros idiomas, Registrar vocabulário, Anotações importantes e utilizar IA's como chatGPT e Bard para este fim.
              ...
              <div class="col-md-8">
                <div id="spacelingo" class="carousel slide border-carousel" data-ride="carousel">
                  <ol class="carousel-indicators">
                    <li data-target="#spacelingo" data-slide-to="0" class="active"></li>
                    <li data-target="#spacelingo" data-slide-to="1"></li>
                    <li data-target="#spacelingo" data-slide-to="2"></li>
                    <li data-target="#spacelingo" data-slide-to="3"></li>
                    <li data-target="#spacelingo" data-slide-to="4"></li>
                    <li data-target="#spacelingo" data-slide-to="5"></li>
                  </ol>
                  <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="d-block w-100" src="{{asset('img/spacelingohome.png')}}" alt="1 slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="{{asset('img/spacelingo1.png')}}" alt="2 slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="{{asset('img/spacelingo2.png')}}" alt="3 slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="{{asset('img/spacelingo3.png')}}" alt="4 slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="{{asset('img/spacelingo4.png')}}" alt="5 slide">
                    </div>
                  </div>
                  <a class="carousel-control-prev" href="#spacelingo" role="button" data-slide="prev">
                    <span>
                      <i class="fa fa-chevron-circle-left texto-dark texto-h1"></i>
                    </span>
                    <span class="sr-only">Previous</span>
                  </a>
                  <a class="carousel-control-next" href="#spacelingo" role="button" data-slide="next">
                    <span>
